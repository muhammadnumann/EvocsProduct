import CandidatetInformation from '../CandidateInformation/Candidateinformation';
import CandidateTimeline from '../CandidateInformation/CandidateTimeline';
import CandidateNotes from '../CandidateInformation/notes';
