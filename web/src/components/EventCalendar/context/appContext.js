...
import { compareDates } from '../utilities/datePicker';
...
class Context {
  ...
  static getLocalDay() {
    return +localStorage.getItem('daySelected') === undefined
      ? 1
      : +localStorage.getItem('daySelected');
  }

  static getLocalMonth() {
    return +localStorage.getItem('monthSelected') === undefined
      ? 1
      : +localStorage.getItem('monthSelected');
  }

  static getLocalYear() {
    return +localStorage.getItem('yearSelected') === undefined
      ? 1
      : +localStorage.getItem('yearSelected');
  }
