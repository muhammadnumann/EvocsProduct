...
const arrayData = [
  {
    ...
    description:
      'He demonstrated a willingness to learn and grow, sending him to the next round.',
  },
  {
    name: 'Michael Foster',
    description:
      'I was impressed with his professionalism and demeanor during the interview. Ricardo came across as confident, poised, and well-prepared.',
  },
  {
    name: 'Tron Javolta',
    description:
      'Fun interview, I had a great time discussing our tech stack with Ricardo.',
  },
];
function NotesTabs() {
  return (
